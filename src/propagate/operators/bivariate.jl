...
function propagate_skip(prop_method, layer::typeof(vcat), bound1::ImageZonoBound, bound2::ImageZonoBound, batch_info)
    new_c = bound1.center + bound2.center
    new_g = cat([bound1.generators, bound2.generators]..., dims=4)
    return ImageZonoBound(new_c, new_g)
end
...
function propagate_skip_batch(prop_method, layer::typeof(+), bound1::IBPBound, bound2::IBPBound, batch_info)
    new_low = bound1.batch_low .+ bound2.batch_low
    new_up = bound1.batch_up .+ bound2.batch_up
